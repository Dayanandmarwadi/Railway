				  ...
				  <div class="modal-body" >
					...
					echo $_SESSION["studentname_session"]?></span></h5></br>
					  ...
					  <div class="form-group" >
						...
						<option id="Churchgate Station"value="Churchgate Station">kataraj</option>
						<option id="Marine Lines"value="Marine Lines">pune station</option>
						<option id="Charni Road Station"value="Charni Road Station">shivaji nagar</option>
						<option id="Grant Road"value="Grant Road">koregao park</option>
						<option id="Mumbai Central"value="Mumbai Central">vimanagar</option>
						<option id="Mahalaxmi"value="Mahalaxmi"> bhosari</option>
						<option id="Lower Parel"value="Lower Parel"> pcmc</option>
						<option id="Elphinstone Road"value="Elphinstone Road">swargate</option>
						<option id="Dadar"value="Dadar">vanaz Ramwadi</option>
						<option id="Matunga Road" value="Matunga Road">hinjawadi</option>
